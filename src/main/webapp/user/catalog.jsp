...
<%@page import="ru.onlineshop.domain.goods.*"%>
	...
	<div class="navbar navbar-default navbar-static-top">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="user/catalog.jsp"><span>OnlineShop</span><br></a>
			</div>
			...
			<div class="row">
				<div class="col-md-3">
					<ul class="list-group">
						...
						%>
						<li class="list-group-item"><a href="catalog.jsp?groupid=<%=group.getId()%>&subgroupid=<%=subGroup.getId()%>"> --- <%=subGroup.getName()%></a></li>
						<%
						    }
						                ...
						                && (null != request.getParameter("subgroupid"))) {
						%>
						<li class="list-group-item"><a href="catalog.jsp?groupid=<%=group.getId()%>"><%=group.getName()%></a></li>
						<%
						    for (Group subGroup : group.getGroupList()) {
					...
					<table class="table">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<form action="../ShoppingCartManager" method="post">
										<input type="hidden" name="id" value="<%=good.getId()%>"> <input type="hidden" name="action" value="order">
										<input align="middle" type="submit" value="Order">
									</form>
								</td>
							</tr>
							<%
