		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbar-ex-collapse">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="active"><a href="addgroup.jsp">New Group</a></li>
			...
			<div class="row">
				...
				<div class="col-md-4">
					<form role="form" action="addgroup">
						...
						<div class="form-group">
							<label class="control-label" for="groupName">Enter group name:</label> <input class="form-control" id="groupname"
								name="groupname" placeholder="Group name" type="text">
						</div>
						<button type="submit" class="btn btn-primary form-control">Add new Group</button>
					</form>
				</div>
				<div class="col-md-4"></div>
			</div>
